...
class RandomWalkStrategy(BaseStrategy, StrategyLoggingMixin):
    def __init__(self, num_trials=1, max_generations=None):
        """
        Args:
        ...
        super().__init__("random_walk", params)
            ...
            while not trial_extinct:
                ...
                while not np.all(env.done):
                    ...
                    if env.verbose and env.current_step % 20 == 0:
                        ...
                        print(f"Trial {trial}, Gen {generation}, Step {env.current_step}, Active agents: {active}")
